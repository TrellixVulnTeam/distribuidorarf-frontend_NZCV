...
@Component({
  selector: 'app-empleado-popup',
  templateUrl: './empleado-popup.component.html',
  styleUrls: ['./empleado-popup.component.scss'],
  providers: [
    { provide: MAT_DATE_FORMATS, useValue: MY_DATE_FORMATS }
  ]
})
export class EmpleadoPopupComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<EmpleadoPopupComponent>,
  ...
  buildItemForm(item) {            
    ...
    this.thirdFormGroup = this.fb.group({
      ...
      autorizacion: [item.codigoAutorizacion || ''],
      codigoEmpleado: ['']
    });
  }
  ...
  submit() {
    ...
    this.personaDTO.codigoAutorizacion = this.thirdFormGroup.controls.autorizacion.value;
    this.personaDTO.termino = this.termino.idTermino;
    this.personaDTO.otrasSenas = this.secondFormGroup.controls.otrasSenas.value; 
    this.personaDTO.codigoResponsable = this.thirdFormGroup.controls.codigoEmpleado.value;
  ...
  empleadoConAutrizacion(){
    ...
    this.listaEmpleados.forEach(element => {
      ...
      if(element.codigoAutorizacion === this.thirdFormGroup.controls.codigoEmpleado.value && element.tipoPersona === environment.ADMIN){
        autorizado = true;
        return autorizado;
      }      
    });
